...
export abstract class BaseXSelector extends BaseSelector {
    ...
    create_scales() {
        ...
        if(this.model.get("scale")) {
            const that = this;
            // @ts-ignore
            return this.create_child_view(this.model.get("scale")).then(function(view: Scale) {
                that.scale = view;
...
export abstract class BaseXYSelector extends BaseSelector {
    ...
    create_scales() {
        ...
        if(this.model.get("x_scale")) {
            //  @ts-ignore
            scale_promises.push(this.create_child_view(this.model.get("x_scale")).then(function(view: Scale) {
                that.x_scale = view;
        ...
        if(this.model.get("y_scale")) {
            //  @ts-ignore
            scale_promises.push(this.create_child_view(this.model.get("y_scale")).then(function(view: Scale) {
                that.y_scale = view;
